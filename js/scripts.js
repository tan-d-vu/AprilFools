...
if(window.scrollY===0){navbarCollapsible.classList.remove('navbar-shrink')}else{navbarCollapsible.classList.add('navbar-shrink')}};if(document.body.querySelector('#blog-list')||document.body.querySelector('#blog-post')||document.body.querySelector('#guide-onboard')){}else{navbarShrink();document.addEventListener('scroll',navbarShrink);console.log("asdfasdf")}
